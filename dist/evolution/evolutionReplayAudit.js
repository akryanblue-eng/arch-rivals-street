...
exports.attemptDirectDeploy = attemptDirectDeploy;
exports.recordSimulationEnforced = recordSimulationEnforced;
exports.replayFrom = replayFrom;
exports.diff = diff;
exports.dumpLedger = dumpLedger;
exports.resetLedger = resetLedger;
exports.recordProposalCreated = recordProposalCreated;
exports.buildEvidenceRecord = buildEvidenceRecord;
...
// did not proceed.
function attemptDirectDeploy(proposalId) {
    ...
    const event = {
        ...
        proposalId,
        ledgerRef: "NONE",
        blockReason: "Direct deploy attempted without AEP simulation. Deployment blocked by audit layer.",
    };
    ledger.push(event);
    return "DETECTED";
}
...
function recordSimulationEnforced(proposalId, ledgerRef) {
    simulationRequirementEnforced = true;
    const event = {
        eventId: nextId(),
...
function diff(baselineErrorRate, candidateErrorRate) {
...
function recordProposalCreated(proposal) {
    const event = {
        eventId: nextId(),
...
function buildEvidenceRecord(outcomes) {
    return {
        slice: "E",
